"""Regression checks for the granite-lang-bytecode-probe casebook."""
...
from casebook.harness import assert_expected, granite_lang_bytecode_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_lang_bytecode_probe_summary(), assert_expected())
